        ...
        if ($error != "") {
            ...
            if ($_POST['signUp'] == '1') {
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    $query = "INSERT INTO `testusers` (`email`, `password`) VALUES ('".mysqli_real_escape_string($link, $_POST['email'])."', '".mysqli_real_escape_string($link, $_POST['password'])."')";
                    ...
                    if (isset($row)) {
                        ...
                        if ($hashedPassword == $row['password']) {
                            ...
                            $error = "Hello That email/password combination could not be found.";

                        }

                    } else {

                        $error = "Hi That email/password combination could not be found.";
